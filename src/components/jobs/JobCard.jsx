...
export default function JobCard({ job }) {
  ...
  return (
    <Card className="p-6 w-full border-none bg-zinc-900 text-zinc-100 rounded-[32px] shadow-2xl">
  ...
  className="group flex items-center gap-2 text-base font-medium text-white hover:text-zinc-300 transition-all duration-200"
>
  Apply Now
  <ArrowRight
    className="group-hover:translate-x-1 text-zinc-400 group-hover:text-white w-4 h-4 transition-transform duration-200"
    aria-hidden="true"
  />
</Link>
      </Card.Footer>
